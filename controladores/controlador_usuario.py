...
def registrar_usuario_cliente(nombres,apellidos,email,telefono,direccion,dni,username,password,tipo_usuario):
    conexion = obtenerConexion()
    with conexion.cursor() as cursor:
        cursor.execute("INSERT INTO usuario(nombres,apellidos,email,telefono,direccion,dni,username,password,tipo_usuario) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                       (nombres,apellidos,email,telefono,direccion,dni,username,password,tipo_usuario))
    conexion.commit()
    conexion.close()
